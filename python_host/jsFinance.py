...
TA Yug Deepak Rajani: You can have a section "Prerequisites" as a part of which you can call out that Python and 
...
todo: yfinance implementation in jsFinance class. I'm thinking that we MANUALLY have people update this. My tables_create
      starts with stock values so in the worst case,we just would have outdated stock information. 
