...
('AIG', 'American International Group', 65.8),
('ALL', 'Allstate Corp', 138.7),
('AMGN', 'Amgen', 271.87),
('AMZN', 'Amazon.Com Inc', 143.55),
('AXP', 'American Express Company', 172.1),
...
('BMY', 'Bristol-Myers Squibb Company', 49.8),
...
("KMI", "Kinder Morgan", 17.850),
("KO", "Coca-Cola Company", 58.550),
("LLY", "Eli Lilly and Company", 583.280),
("LMT", "Lockheed Martin Corp", 450.290),
("LOW", "Lowe's Companies", 205.710),
("MA", "Mastercard Inc", 407.090),
("MCD", "McDonald's Corp", 286.550),
("MDLZ", "Mondelez Intl Cmn A", 71.060),
("MDT", "Medtronic Inc", 79.550),
("MET", "Metlife Inc", 64.130),
("MMM", "3M Company", 102.750),
("MO", "Altria Group", 42.320),
("MRK", "Merck & Company", 104.920),
("MS", "Morgan Stanley", 80.680),
("MSFT", "Microsoft Corp", 366.450),
("NEE", "Nextera Energy", 58.680),
("NKE", "Nike Inc", 114.660),
("ORCL", "Oracle Corp", 114.570),
("OXY", "Occidental Petroleum Corp", 57.980),
("PEP", "Pepsico Inc", 169.150),
("PFE", "Pfizer Inc", 29.210),
("PG", "Procter & Gamble Company", 152.140),
("PM", "Philip Morris International Inc", 92.520),
("PYPL", "Paypal Holdings", 59.310),
("QCOM", "Qualcomm Inc", 129.090),
("SBUX", "Starbucks Corp", 97.380),
("SLB", "Schlumberger N.V.", 51.660),
("SO", "Southern Company", 71.380),
("SPG", "Simon Property Group", 129.895),
("T", "AT&T Inc", 16.980),
("TGT", "Target Corp", 133.320),
("TXN", "Texas Instruments", 156.460),
("UNH", "Unitedhealth Group Inc", 549.100),
("UNP", "Union Pacific Corp", 232.790),
("UPS", "United Parcel Service", 155.000),
("USB", "U.S. Bancorp", 39.260),
("USD", "Ultra Semiconductors Proshares", 42.490),
("V", "Visa Inc", 254.190),
("VZ", "Verizon Communications Inc", 38.350),
("WBA", "Walgreens Bts Aln Cm", 20.730),
("WFC", "Wells Fargo & Company", 44.950);
